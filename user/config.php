...
define( 'YOURLS_DB_PASS', '2222' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'yourls_yourlsdb' );
...
define( 'YOURLS_SITE', 'https://aa2.us' );
...
$yourls_user_passwords = [
	'admin' => 'phpass:!2y!10!LFcJan.3beRu1nbK4LCpZODbAonQYBLGKwDxriMf4W7yRPX7c2I3e' /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2',
